    ...
    <footer className="p-4 border-top">
        <div className="container align-items-center justify-content-between d-flex">
            ...
            <ul className="nav">
                ...
                <li className="nav-item">
                <a href="https://stackoverflow.com/users/19713911/xiaojing-deng" className="nav-link text-muted"><img src="https://icons.iconarchive.com/icons/limav/flat-gradient-social/128/Stackoverflow-icon.png" alt="Stack Overflow" className="icon"/></a> 
                </li>
            </ul>
       </div>
    </footer>
